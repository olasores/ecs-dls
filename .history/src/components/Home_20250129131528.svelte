...
<main class="min-h-screen">
  ...
  <Slider />
    ...
    <!-- Countdown Section with Curved Top -->
<section class="bg-white w-full rounded-t-[50px] md:rounded-t-[100px] rounded-b-[50px] md:rounded-b-[100px] p-6 md:p-10 overflow-hidden relative -mt-[50px] md:-mt-[100px]">
  <div class="flex flex-col md:flex-row justify-center items-center text-center md:text-left">
    <h1 class="text-2xl md:text-3xl font-bold mb-4 md:mb-8 md:mr-10">
      The Countdown <span class="text-orange-300">begins</span>
    </h1>
    <Countdown />
  </div>
</section>
...
<!-- About Section -->
<section class="w-full px-5 py-10 flex flex-col-reverse md:flex-row items-center bg-gray-50 gap-6">
  <!-- Text Section -->
  ...
  <div class="w-full md:w-1/2 flex justify-center">
    <img
      ...
      alt="About the event"
      class="object-cover w-[300px] h-[300px] md:w-[400px] md:h-[400px]"
    />
  </div>
</section>


    <section class="w-full pr-5 flex pb-5 items-center bg-gray-50">
        <!-- Image Section -->
        ...
        <div class="w-1/2">
          ...
          <p class="text-sm font-semibold text-[#FF914C] uppercase tracking-wider mb-3 flex items-center gap-2">
            <span class="w-8 h-[1px] bg-[#FF914C]"></span>
             About the Event
             <span class="w-8 h-[1px] bg-[#FF914C]"></span></p>
