<script>
  ...
  <main class="px-6 sm:px-12 lg:px-24 py-10">
    ...
    <div class="text-center mb-8"><p class="text-sm font-semibold text-[#FF914C] flex items-centr justify-center md:justify-start items-center gap-2 uppercase tracking-wider">
