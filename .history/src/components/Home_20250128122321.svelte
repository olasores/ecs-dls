      ...
      <div class="relative">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl">
          ...
          <div class="bg-white rounded-lg overflow-hidden flex flex-col h-auto">
            <img src="/assets/panel-h.png" alt="Keynote Speaker" class="w-full h-50 object-cover" />
            <div class="p-6">
          ...
          <div class="bg-white rounded-lg overflow-hidden flex flex-col h-auto">
            <img src="/assets/n-new.png" alt="Networking Opportunities" class="w-full h-50 object-cover" />
            <div class="p-6">
