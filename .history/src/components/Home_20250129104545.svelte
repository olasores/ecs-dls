      ...
      <div class="relative">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl">
          ...
          <div class="bg-white rounded-lg overflow-hidden flex flex-col h-auto">
            <img src="/assets/k-note.png" alt="Keynote Speaker" class="w-full h-50 object-cover" />
            <div class="p-6">
          ...
          <!-- Engaging Panelists -->
          <div class="bg-white rounded-lg overflow-hidden flex flex-col h-auto">
            <img src="/assets/p-new.png" alt="Engaging Panelists" class="w-full h-50 object-cover" />
            <div class="p-6">
