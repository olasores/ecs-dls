...
<div class="flex flex-col items-center gap-4 w-full max-w-6xl mx-auto px-4">
  <!-- Title -->
  <h2 class="text-2xl md:text-3xl font-bold text-center mb-2">Countdown to the Summit</h2>

  <!-- Countdown Container -->
  <div class="flex gap-4 items-center justify-center">
      <!-- Days -->
      <div>
          <div class="bg-[#FF914C] rounded-md flex flex-col justify-center items-center p-4 h-32 w-24 md:w-40 md:h-40">
...
<div class=" flex flex-col md:flex-row gap-2 w-full max-w-6xl mx-auto px-4">
  <!-- Title -->
  <h2 class="text-2xl md:text-3xl font-bold text-center mb-0 ">Countdown to the Summit</h2>
