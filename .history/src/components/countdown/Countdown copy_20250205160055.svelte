...
<div class=" flex flex-col md:flex-row gap-20 w-full max-w-6xl mx-auto px-4">
  <!-- Title -->
   <div class="flex items-center">
    <h2 class="text-2xl md:text-3xl font-bold text-center mb-0 ">The Countdown 
      <span class="text-[#FF914C] text-3xl">begins</span>
    </h2> 
