...
let events = {
  ...
  "Day 2": [
    ...
    },
    {
      ...
      image: "assets/p-new.png" // Panel discussion
    },
    {
      id: 12,
      date: "February 22",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=800&auto=format&fit=crop" // Workshop
    },
    {
      id: 14,
      date: "February 22",
      ...
      {#each events[selectedDay] as event}
        <div class="flex bg-white shadow-md rounded-lg overflow-hidden">
          ...
          <div class="w-2/3 p-6 flex flex-col justify-between">
            <div>
              <h3 class="text-lg font-bold text-orange-500 mb-2">{event.title}</h3>
      ...
      {#each events[selectedDay] as event}
        <div class="flex bg-white shadow-md rounded-lg overflow-hidden">
          ...
          <div class="w-2/3 p-6 flex flex-col justify-between">
            ...
            <div class="text-sm text-gray-500">
              <p class="flex items-center">
                <svg class="w-5 h-5 mr-2" fill="#FF914C" viewBox="0 0 24 24">
                  <path d="M12 0C7.8 0 4 3.4 4 7.6c0 4.2 3.4 7.6 7.6 7.6 4.2 0 7.6-3.4 7.6-7.6C19.2 3.4 15.8 0 12 0zm0 11.5c-2.2 0-4-1.8-4-4s1.8-4 4-4 4 1.8 4 4-1.8 4-4 4z"/>
                  <path d="M12 13.2c-4.8 0-8.8 3.6-8.8 8.4v2.4h17.6v-2.4c0-4.8-4-8.4-8.8-8.4z"/>
                </svg>
                {event.location}
              </p>
              <p class="flex items-center mt-2">
