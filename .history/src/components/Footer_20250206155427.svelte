    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div class="col-span-1">
        ...
        <FooterLinkGroup ulClass="space-y-2">
          ...
          <FooterLink href="/services" class="hover:text-white transition-colors">Venue</FooterLink>
          <FooterLink href="/contact" class="hover:text-white transition-colors">Schedule</FooterLink>
        </FooterLinkGroup>
      </div>
