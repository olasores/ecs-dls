  ...
  const keynoteSpeakers = [
    {
      ...
      keynoteTitle: "The Future of AI in Enterprise Solutions"
    },
    {
      ...
      keynoteTitle: "Data-Driven Decision Making in the Digital Age"
    }
  ];
...
<main class="min-h-screen bg-gray-50">
   ...
   <section class="mx-auto "> 
    ...
    <div class="flex flex-col md:flex-row items-center gap-6">
      ...
      <div class="w-full md:w-1/3">
        <img src="https://via.placeholder.com/300" alt="Keynote Speaker Image" class="rounded-lg shadow-lg w-full">
      </div>
      ...
      <div class="flex ">
        ...
        <div>
          <h2 class="text-3xl md:text-5xl font-bold font-judson"> Jose Tilapia </h2>
          <p>Jose Tapia is the CEO and Co-Founder of Meru AI, a company whose mission is to use Artificial Intelligence and Machine Learning (AI/ML) to reduce the barriers of entry while elevating the endless possibilities of solutions to critical problems. In his role, Jose helps Small Medium Enterprise companies embrace AI/ML within diverse industries including Finance, Marketing, Video Games, and Business Infrastructure. Wearing many hats, Jose participates within the full cycle of visionary and technological development. 
          </p>
        </div>
      </div>
   </section>
  <section class="max-w-7xl mx-auto px-6 mb-16">
    <div class="text-center mb-12">
      <span class="text-orange-600 font-medium mb-2">Featured Presentations</span>
      <h2 class="text-3xl md:text-4xl font-bold font-judson text-gray-800 mb-4">Keynote Speakers</h2>
      <p class="text-gray-600 max-w-2xl mx-auto">Industry leaders sharing groundbreaking insights and innovations</p>
    </div>
      ...
      {#each keynoteSpeakers as speaker}
        <div class="group relative overflow-hidden rounded-lg bg-white shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <div class="p-4">
            ...
            <p class="text-gray-800 font-medium text-sm mb-2">{speaker.keynoteTitle}</p>
