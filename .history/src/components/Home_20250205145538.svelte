  ...
  <Slider />
    ...
    <section class="w-full px-5 py-10 flex flex-col md:flex-row items-center bg-gray-50 gap-6">
      ...
      <div class="w-full md:w-1/2 text-center md:text-left">
        ...
        <p class="text-base md:text-lg leading-relaxed text-gray-700">
          Join us for an immersive two-day journey at the ECS Bridge Builders Summit, where innovation meets action. Through dynamic keynotes, hands-on workshops, and collaborative activities, participants will explore the intersection of leadership, technology, and diverse perspectives. Whether you're engaging in thought-provoking panel discussions, participating in interactive problem-solving sessions, or networking with fellow changemakers, each moment is designed to inspire and equip you with practical tools for leading in an AI-driven world.        </p>
      </div>
    </section>
