   ...
   <section class="mx-auto "> 
    ...
    <div class="flex flex-col md:flex-row items-center gap-6">
      ...
      <div class="w-full md:w-1/3">
        <img src="https://images.unsplash.com/photo-1580489944761-15a19d654956?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3" alt="Keynote Speaker Image" class="rounded-lg shadow-lg w-full">
      </div>
